-- auto-generated KitsData for GFI
return {
  ["GFI_Recruit"] = {
    ["displayName"] = "RECRUIT",
  ...
  ["GFI_SL_02"] = {
    ...
    ["specifics"] = "Use the Squad Leader Menu ({Key0}) to place a Rally Points or FOB Deployables",
    ["uiIcon"] = "T_role_squadleader",
    ["uiWeapon"] = "g3ka4_foregrip_zpoint",
    ["baseTeamAvailability"] = -1,
    ["capability"] = "Light",
    ["items"] = {
